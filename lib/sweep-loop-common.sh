...
# read_resume_hint() -- #345. Turns SCHEDULER_RESUME_PR/_REPO (usage-paced-
# runner.sh's resume_hint_for_project()) into a prompt prefix, same slot as
# read_ceiling_breadcrumb. No file to consume -- recomputed every dispatch.
read_resume_hint() {

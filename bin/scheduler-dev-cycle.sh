...
HARD RULES (infrastructure, not an app):
  ...
  * On a real judgment call, file it with 'bin/scheduler ask scheduler \"<the question>\"' (it opens a GitHub issue) and describe it in the report rather than deciding unilaterally.
